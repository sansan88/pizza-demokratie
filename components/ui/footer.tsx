...
const Footer = () => {
  ...
  return (
    <footer className="mt-8 py-4 bg-gray-100 text-center text-sm text-gray-600">
      <p>Made with ❤️ by Democracy Watch</p>
      <p>&copy; {currentYear} democracy-watch.ch. Alle Rechte vorbehalten.</p>
      <p>
        ...
        <Link href="/about" className="text-blue-600 hover:underline ml-2">
          Über uns
        </Link> |
