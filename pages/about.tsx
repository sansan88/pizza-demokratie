    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="pt-24 pb-12 bg-gradient-to-b from-gray-900 to-gray-700 text-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl">Erfahren Sie mehr über Democracy Watch</p>
        </div>
      </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="w-full max-w-2xl mx-auto shadow-lg">
          <CardContent className="space-y-6 p-6">
            ...
            <p>Democracy Watch hat es sich zur Aufgabe gemacht, den demokratischen Prozess in der Schweiz zu unterstützen und zu vereinfachen...</p>
